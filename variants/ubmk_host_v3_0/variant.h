...
#ifndef _UBMK_HOST_V3_0_H
#define _UBMK_HOST_V3_0_H
...
// Other pins
#define PIN_VIDV           _PINNUM(0, 9)
#define PIN_HOST_INT       _PINNUM(0, 30)
#define PIN_HOST_SS        _PINNUM(0, 31)
...
#define PIN_SPI_MISO         _PINNUM(0, 5)
#define PIN_SPI_MOSI         _PINNUM(1, 9)
#define PIN_SPI_SCK          _PINNUM(0, 13)

static const uint8_t SS   = _PINNUM(0, 31);
...
#define PIN_WIRE_SDA         _PINNUM(1, 11)
#define PIN_WIRE_SCL         _PINNUM(1, 10)
