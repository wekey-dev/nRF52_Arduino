...
#define PIN_BOOT_CTRL      _PINNUM(0, 10)
#define PIN_HOST_EN        _PINNUM(0, 13)
#define PIN_HOST_INT       _PINNUM(0, 17)
#define PIN_HOST_SS        _PINNUM(0, 24)
...
#define PIN_SPI_MISO         _PINNUM(0, 22)
#define PIN_SPI_MOSI         _PINNUM(0, 20)
#define PIN_SPI_SCK          _PINNUM(1, 0)

static const uint8_t SS   = _PINNUM(0, 24);
...
#define PIN_WIRE_SDA         _PINNUM(0, 6)
#define PIN_WIRE_SCL         _PINNUM(0, 26)
#define PIN_WIRE_SDB         _PINNUM(0, 4)
