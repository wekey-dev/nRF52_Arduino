...
#define PIN_CHARGE_CTRL    _PINNUM(0, 10)
#define PIN_CHARGE_STAT    _PINNUM(0, 9)
#define PIN_BOOT_CTRL      _PINNUM(1, 6)
#define PIN_HOST_GPX       _PINNUM(1, 0)
#define PIN_HOST_INT       _PINNUM(0, 24)
#define PIN_HOST_SS        _PINNUM(0, 13)
#define PIN_HOST_RST       _PINNUM(0, 15)

#define PIN_LS1            _PINNUM(0, 2)
#define PIN_LS2            _PINNUM(0, 28)
#define PIN_LS3            _PINNUM(0, 3)
#define PIN_LS4            _PINNUM(1, 10)
...
#define PIN_SPI_MISO         _PINNUM(0, 20)
#define PIN_SPI_MOSI         _PINNUM(0, 22)
#define PIN_SPI_SCK          _PINNUM(0, 17)

static const uint8_t SS   = _PINNUM(0, 13);
